...
public class GUIManager {
    ...
    private int DEFAULT_SIZE = 370; // 메뉴 패널의 크기 상수화
    ...
    private void initialize() {
        ...
        menuPanel.setBounds(25, 20, 800, DEFAULT_SIZE);
        menuPanel.setBackground(Color.gray);
        menuPanel.setLayout(null);
        
        // 메뉴패널에 추가할 스크롤 패널 생성
        JScrollPane scrollPane = new JScrollPane(menuPanel);
        scrollPane.setBounds(25, 20, 800, DEFAULT_SIZE + 20);
        ...
        processedMenuPanel.setBounds(25, 440, 800, DEFAULT_SIZE);
        ...
        scrollPane.setBounds(25, 440, 800, DEFAULT_SIZE + 20);
    ...
    public void processSocketMessage(String message) {
		...
		// 메시지를 보여줄 라벨 생성
    	CreateOrderPanel cop = new CreateOrderPanel(menuPanel, message, Right_panel, messageLabel, processedMenuPanel, DEFAULT_SIZE);
    	cop.Creating();
